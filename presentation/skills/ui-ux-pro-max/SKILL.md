...
The search script lives inside this vendored Skill. Resolve `<skill-directory>` to the directory containing this `SKILL.md`, and invoke the script by its full path so the command works from any working directory:
